            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 justify-between items-center">
                <div className="leftSide">
                    ...
                    <div className="flex justify-center lg:justify-start pb-3">
                        <NavLink className='mt-2 btn px-10 font-bold bg-linear-to-r from-[#2be9c8] to-[#a26bff] border-0 text-black'>Explore Games <span className="flex items-center"><FaLongArrowAltRight className="flex mt-1" /></span></NavLink>
                    </div>
                </div>
