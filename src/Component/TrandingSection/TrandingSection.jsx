    ...
    return (
        <div className="mt-3 pb-7 w-11/12 mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mt-16  lg:mt-19 pb-6">
                {
                    SelectedData.map((items,index)=><TrandingGamesCard key={index} items={items}></TrandingGamesCard>)
                }
            </div>
            <button className="btn mx-auto flex justify-center px-10 border-0 bg-linear-to-r from-[#2be9c8] to-[#a26bff]">See All</button>
        </div>
    );
};
